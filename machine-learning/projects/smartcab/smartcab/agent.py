...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if self.epsilon > 0:
            # self.epsilon -= 0.05
            self.epsilon = math.cos(self.alpha * self.num_trials)
            self.num_trials += 1
    ...
    def build_state(self):
        ...
        return inputs['light'], waypoint, inputs['oncoming'], inputs['left']
    ...
    def choose_action(self, state):
        ...
        if not self.learning:
            ...
            if random.random() < self.epsilon:
                ...
                possible_actions = [a for a in self.valid_actions if self.Q[state][a] == max_q]
    ...
    def learn(self, state, action, reward):
        ...
        if self.learning:
            ...
            # With discount of 0, this becomes
